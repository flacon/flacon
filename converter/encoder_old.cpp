 ...
 *
 ************************************************/
Encoder_OLD::Encoder_OLD(QObject *parent) :
    Worker(parent)
{
}
 ...
 *
 ************************************************/
QProcess *Encoder_OLD::createEncoderProcess()
{
 ...
 *
 ************************************************/
QProcess *Encoder_OLD::createRasmpler(const QString &outFile)
{
...
************************************************/
QProcess *Encoder_OLD::createDemph(const QString &outFile)
{
 ...
 **************************************/
void Encoder_OLD::stopProcesses(QList<QProcess *> procs)
{
...
void Encoder_OLD::run()
{
    ...
    try {
        ...
        connect(procs.first(), &QProcess::bytesWritten, this, &Encoder_OLD::processBytesWritten);
 ...
 *
 ************************************************/
void Encoder_OLD::writeMetadata() const
{
 ...
 ************************************************/
void Encoder_OLD::processBytesWritten(qint64 bytes)
{
    mReady += bytes;
 ...
 ************************************************/
void Encoder_OLD::setProfile(const Profile &profile)
{
    mProfile = profile;
}
 ...
 ************************************************/
void Encoder_OLD::setCoverImage(const CoverImage &value)
{
    mCoverImage = value;
}
 ...
 ************************************************/
void Encoder_OLD::readInputFile(QProcess *process)
{
 ...
 ************************************************/
QStringList Encoder_OLD::resamplerArgs(int bitsPerSample, int sampleRate, const QString &outFile)
{
    QStringList args;
 ...
 ************************************************/
QStringList Encoder_OLD::deemphasisArgs(const QString &outFile)
{
    QStringList args;
