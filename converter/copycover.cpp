 ...
 *
 ************************************************/
CopyCover::CopyCover(const QString &inFile, const QString &outDir, const QString &outBaseName, int newSize) :
    mInFile(inFile),
    mSize(newSize),
    mDir(outDir),
