...
void TestFlacon::testReadWavHeader_data()
{
    ...
    QTest::newRow("01") << "52 49 46 46" // RIFF
    ...
    QTest::newRow("02") << "52 49 46 46" // RIFF
    ...
    QTest::newRow("03") << "52 49 46 46" // RIFF
    ...
    QTest::newRow("04") << "52 49 46 46" // RIFF
    ...
    QTest::newRow("05") << "52 49 46 46" // RIFF
                           "D0 9B 9B AF" // file size - 8
                           "57 41 56 45" // WAVE
    ...
    QTest::newRow("06 zero duration") << "52 49 46 46" // RIFF
